...
public class ReportController {
	...
	public String details(Model model, @PathVariable int id) {
		Report reportId = reportRepository.findOne(id);
		if (reportId != null) {
	...
	public String createProcess(Model model, ReportBindingModel reportBindingModel) {
		if (reportBindingModel.equals("") || reportBindingModel.getMessage().equals("")) {
	...
	public String deleteProcess(@PathVariable int id, ReportBindingModel reportBindingModel) {
		Report taskId = reportRepository.findOne(id);
		reportRepository.delete(taskId);
		return "redirect:/";
	}
}
